                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Package List</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <!--end::Svg Icon-->
                                                <input type="text" data-kt-package-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Packages" />
                                            </div>
                                            <!--end::Search-->
                                        </div>
                                        <!--begin::Card title-->
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-package-table-toolbar="base">
                                                ...
                                                <!--begin::Export-->
                                                <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_packages_export_modal">
                                                ...
                                                <!--end::Export-->
                                                <!--begin::Add package-->
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_package">Add Package</button>
                                                <!--end::Add package-->
                                            </div>
                                            <!--end::Toolbar-->
                                            <!--begin::Group actions-->
                                            <div class="d-flex justify-content-end align-items-center d-none" data-kt-package-table-toolbar="selected">
                                                ...
                                                <button type="button" class="btn btn-danger" data-kt-package-table-select="delete_selected">Delete Selected</button>
                                            </div>
                                            <!--end::Group actions-->
                                        </div>
                                        <!--end::Card toolbar-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_packages_table">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-125px">Package Type</th>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="#" data-id="<?php echo $row['id'] ?>" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_package" data-kt-package-table-filter="edit_row">Edit</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
                                                                <div class="menu-item px-3">
                                                                    <a href="#" data-id="<?php echo $row['id'] ?>" class="menu-link px-3" data-kt-package-table-filter="delete_row">Delete</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                            </div>
                                                            <!--end::Menu-->
                                ...
                                <div class="modal fade" id="kt_modal_add_package" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            <!--begin::Form-->
                                            <form class="form" action="#" id="kt_modal_add_package_form" data-kt-redirect="../../demo1/dist/apps/packages/list.html">
                                                <!--begin::Modal header-->
                                                <div class="modal-header" id="kt_modal_add_package_header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bold">Add a Package</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                    <div id="kt_modal_add_package_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                                ...
                                                <div class="modal-body py-10 px-lg-17">
                                                    <!--begin::Scroll-->
                                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_package_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_package_header" data-kt-scroll-wrappers="#kt_modal_add_package_scroll" data-kt-scroll-offset="300px">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" id="packagename" class="form-control form-control-solid" placeholder="" name="packagename" value="" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <div class="fv-row mb-15">
                                                            <!--begin::Label-->
                                                            <label class="required sfs-6 fw-semibold mb-2">Package Price</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" id="packageprice" class="form-control form-control-solid" placeholder="" name="packageprice" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                ...
                                                <div class="modal-footer flex-center">
                                                    <!--begin::Button-->
                                                    <button type="reset" id="kt_modal_add_package_cancel" class="btn btn-light me-3">Discard</button>
                                                    <!--end::Button-->
                                                    <!--begin::Button-->
                                ...
                                <!--end::Modal - Packages - Add-->
                                <!--begin::Modal - Packages - Edit-->
                                <div class="modal fade" id="kt_modal_edit_package" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        <!--begin::Modal content-->
                                        <div class="modal-content">
                                            <!--begin::Form-->
                                            <form class="form" action="#" id="kt_modal_edit_package_form" data-kt-redirect="../../demo1/dist/apps/packages/list.html">
                                                <!--begin::Modal header-->
                                                <div class="modal-header" id="kt_modal_edit_package_header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bold">Edit a Package</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                    <div id="kt_modal_edit_package_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                                        <span class="svg-icon svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
                                                ...
                                                <div class="modal-body py-10 px-lg-17">
                                                    <!--begin::Scroll-->
                                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_package_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_package_header" data-kt-scroll-wrappers="#kt_modal_edit_package_scroll" data-kt-scroll-offset="300px">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" id="editpackagename" class="form-control form-control-solid" placeholder="" name="editpackagename" value="" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <div class="fv-row mb-15">
                                                            <!--begin::Label-->
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" id="editpackageprice" class="form-control form-control-solid" placeholder="" name="editpackageprice" />
                                                            <!--end::Input-->
                                                            <!--begin::Input-->
                                                            <input type="hidden" id="editpackageid" class="form-control form-control-solid" placeholder="" name="editpackageid" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                ...
                                                <div class="modal-footer flex-center">
                                                    <!--begin::Button-->
                                                    <button type="reset" id="kt_modal_edit_package_cancel" class="btn btn-light me-3">Discard</button>
                                                    <!--end::Button-->
                                                    <!--begin::Button-->
                                                    <button type="submit" id="kt_modal_edit_package_submit" class="btn btn-primary">
                                                        <span class="indicator-label">Submit</span>
                                                        <span class="indicator-progress">Please wait...
                                                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                    </button>
                                        ...
                                        <div class="d-flex fv-row">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                <label class="form-check-label" for="kt_modal_update_role_option_4">
                                                    ...
                                                    <div class="text-gray-600">Collect contact information for potential packages</div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Radio-->
