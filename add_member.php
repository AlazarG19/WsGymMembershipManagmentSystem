                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-125px">Remaining Days</th>
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                <?php
                                                $i = 1;
                                                $package = $conn->query("SELECT *,members.id as mid
                                                FROM members
                                                JOIN packages ON members.package_id = packages.id;");
                                                while ($row = $package->fetch_assoc()) :
                                                ?>
                                                    <tr>
                                                        <!--begin::Name=-->
                                                        <td>
                                                            <a href="../../demo1/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1"><?php echo $row['name'] ?></a>
                                                        </td>
                                                        <!--end::Name=-->
                                                        <!--begin::Status=-->
                                                        <td>
                                                            <?php
                                                            // Step 1: Convert date strings into DateTime objects
                                                            $today = new DateTime();
                                                            ...
                                                            // Step 3: Extract the day difference from the interval
                                                            $dayDifference = $interval->days;
                                                            ?>
                                                            <?php if ($end_date > $today) { ?>
                                                                <a href="#" class="text-success text-hover-primary mb-1"><?php echo "$dayDifference days" ?></a>
                                                            <?php } else { ?>
                                                                <a href="#" class="text-danger text-hover-primary mb-1"><?php echo "Expired" ?></a>
                                                            <?php } ?>
                                                        </td>
                                                        <!--end::Status=-->
                                                        <!--begin::Package Type=-->
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="#" data-id="<?php echo $row['mid'] ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
                                                                <div class="menu-item px-3">
                                                                    <a href="#" data-id="<?php echo $row['mid'] ?>" class="menu-link px-3" data-kt-customer-table-filter="renew_row">Renew</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                            </div>
                                                            <!--end::Menu-->
                                                    ...
                                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <div class="input-group" id="kt_td_picker_modal" data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                                <input id="kt_td_picker_modal_input" type="text" class="form-control form-control-solid" name="start_date" data-td-target="#kt_td_picker_modal" />
                                                                <span class="input-group-text" data-td-target="#kt_td_picker_modal" data-td-toggle="datetimepicker">
                                                                    <i class="la la-calendar "><span class="path1"></span><span class="path2"></span></i>
                                                                </span>
                                                            </div>
                                                            <!--end::Input-->
                                                        </div>
                                                        ...
                                                        <div class="d-flex flex-column mb-7 fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <select name="package" aria-label="Select a Package" data-control="select2" data-placeholder="Select a Package..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bold">
                                                        ...
                                                        <div class="fv-row mb-15">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" name="phone_number" class="form-control form-control-solid" placeholder="" name="phonenumber" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                ...
                                <!--begin::Modal - Customers - Renew-->
                                <div class="modal fade" id="kt_modal_renew_customer" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        <!--begin::Modal content-->
                                        <div class="modal-content">
                                            <!--begin::Form-->
                                            <form class="form" action="#" id="kt_modal_renew_customer_form" data-kt-redirect="../../demo1/dist/apps/customers/list.html">
                                                <!--begin::Modal header-->
                                                <div class="modal-header" id="kt_modal_renew_customer_header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bold">Add a Customer</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                    <div id="kt_modal_renew_customer_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                                        <span class="svg-icon svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
