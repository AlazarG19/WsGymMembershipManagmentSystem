														...
														<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
															...
															<tbody class="fs-6 fw-semibold text-gray-600">
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">9077-2611</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">8922-6629</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">7336-9799</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">9316-5950</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">4367-5342</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">9987-2358</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">4082-5089</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">4856-5625</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																...
																<tr>
																	<!--begin::Invoice=-->
																	<td>
																		<a href="#" class="text-gray-600 text-hover-primary mb-1">3290-1618</a>
																	</td>
																	<!--end::Invoice=-->
																	<!--begin::Status=-->
																	<td>
																	...
																	<div class="flex-equal me-5">
																		<table class="table table-flush fw-semibold gy-1">
																			...
																			<tr>
																				...
																				<td class="text-gray-800">**** 2928</td>
																			</tr>
																			<tr>
																...
																<div class="d-flex flex-wrap py-5">
																	...
																	<div class="flex-equal me-5">
																		<table class="table table-flush fw-semibold gy-1">
																			...
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Number</td>
																				<td class="text-gray-800">**** 1266</td>
																			</tr>
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Expires</td>
																...
																<div class="d-flex flex-wrap py-5">
																	...
																	<div class="flex-equal me-5">
																		<table class="table table-flush fw-semibold gy-1">
																			...
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Number</td>
																				<td class="text-gray-800">**** 9063</td>
																			</tr>
																			<tr>
																				<td class="text-muted min-w-125px w-125px">Expires</td>
															...
															<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<!--end::Badge=-->
																		<!--begin::Status=-->
																		<td>POST /v1/customer/c_63d9246f6b4db/not_found</td>
																		<!--end::Status=-->
																		<!--begin::Timestamp=-->
																	...
																	<tr>
																		...
																		<!--end::Badge=-->
																		<!--begin::Status=-->
																		<td>POST /v1/invoices/in_7700_8647/payment</td>
																		<!--end::Status=-->
																		<!--begin::Timestamp=-->
																		<td class="pe-0 text-end min-w-200px">05 May 2023, 6:05 pm</td>
																		<!--end::Timestamp=-->
																	</tr>
																	<!--end::Table row-->
																	<!--begin::Table row-->
																	<tr>
																		...
																		<!--end::Badge=-->
																		<!--begin::Status=-->
																		<td>POST /v1/invoices/in_6793_2947/payment</td>
																		<!--end::Status=-->
																		<!--begin::Timestamp=-->
																	...
																	<tr>
																		...
																		<!--end::Badge=-->
																		<!--begin::Status=-->
																		<td>POST /v1/invoices/in_7396_9831/payment</td>
																		<!--end::Status=-->
																		<!--begin::Timestamp=-->
																	...
																	<tr>
																		...
																		<!--end::Badge=-->
																		<!--begin::Status=-->
																		<td>POST /v1/customer/c_63d9246f6b4dd/not_found</td>
																		<!--end::Status=-->
																		<!--begin::Timestamp=-->
																		<td class="pe-0 text-end min-w-200px">25 Oct 2023, 11:05 am</td>
																		<!--end::Timestamp=-->
																	</tr>
																	<!--end::Table row-->
																	<!--begin::Table row-->
																	...
																	<tr>
																		...
																		<!--end::Badge=-->
																		<!--begin::Status=-->
																		<td>POST /v1/invoices/in_2257_6988/payment</td>
																		<!--end::Status=-->
																		<!--begin::Timestamp=-->
																	...
																	<tr>
																		...
																		<!--end::Badge=-->
																		<!--begin::Status=-->
																		<td>POST /v1/invoice/in_7239_4562/invalid</td>
																		<!--end::Status=-->
																		<!--begin::Timestamp=-->
